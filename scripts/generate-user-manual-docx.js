...
const screenshots = [
  ...
  { file: "11-college-maintenance.png", caption: "Figure 9. College maintenance page", after: "### College" },
  { file: "13-program-maintenance.png", caption: "Figure 10. Program maintenance page", after: "### Program" },
  { file: "12-department-maintenance.png", caption: "Figure 11. Department maintenance page", after: "### Department" },
  { file: "21-item-maintenance.png", caption: "Figure 12. Item maintenance page", after: "### Item" },
  { file: "19-room-maintenance.png", caption: "Figure 13. Room maintenance page", after: "### Room" },
  { file: "17-school-year-maintenance.png", caption: "Figure 14. School Year maintenance page", after: "### School year" },
  { file: "18-semester-maintenance.png", caption: "Figure 15. Semester maintenance page", after: "### Semester" },
  { file: "06-student-maintenance.png", caption: "Figure 16. Student maintenance page", after: "### Student" },
  { file: "07-student-course.png", caption: "Figure 17. Student Course maintenance page", after: "### Student Course maintenance" },
  { file: "08-schedule-assignment.png", caption: "Figure 18. Schedule assignment page", after: "### Schedule assignment" },
  { file: "14-course-maintenance.png", caption: "Figure 19. Course maintenance page", after: "### Course" },
  { file: "15-teacher-maintenance.png", caption: "Figure 20. Teacher maintenance page", after: "### Teacher" },
  { file: "10-activity-log.png", caption: "Figure 21. Activity log", after: "### Activity log" },
  { file: "09-permissions.png", caption: "Figure 22. Permission roles and module access", after: "### Permissions" },
];
